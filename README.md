...
│   ├── biomass_occupation_bulkDO/    # For biomass occupation and bulk DO data series (struct data)
│   ├── growth_erosion_timepoints/    # For biomass growth and erosion data (struct data)
