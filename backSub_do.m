...
% Background subtracted images path
cd(projectPath);
...
%% ---- Load Brightfield Images (ch00) and Mask ----
...
inverted_mask = imread(fullfile(grainMaskPath, "inverted_mask.tif"));
...
%     cleaned = bitand(subtracted, inverted_mask);
% 
%     % Remove bright outliers
%     cleaned = removeBrightOutliers(cleaned, radius, threshold);
% 
%     % Save cleaned image
